 ...
 */
?>
<div id="page-wrapper" class="progects">
 ...
 <!-- !Navigation -->
    ...
    <div id="columns" class="columns clearfix courses col-sm-12">
      ...
      <footer<?php print $footer_attributes; ?>>
        <div class="copyright">
          <div class="copyright-container">
            ©&nbsp;Bresponsive Creator
            <div class="col-sm-9 footerMenu pull-right  "><?php print render($page['footer']); ?></div>
          </div>
        </div>
